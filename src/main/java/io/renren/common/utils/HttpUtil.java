...
public class HttpUtil {
    ...
    public static void main(String[] args) {
        ...
        String s = HttpUtil.sendPost("http://test.going-link.com/modules/itf/OAUTH/itf_client_auth.svc?client_id=1E364864219F0E58&state=state&response_type=code", js.toString());
